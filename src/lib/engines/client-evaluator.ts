...
export function generateClientVentureReport(answers: QuestionnaireAnswers): UnifiedVentureReport {
  ...
  const { aiAnalysis, crossVerification } = generateDomainSynthesis(facts, answers, scores);
